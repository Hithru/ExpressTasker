...
class ServiceProviderProfile extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .post(`${apiUrl}/serviceProvider/profile/${user._id}`)
      .then((response) => {
        console.log(response.data);
        this.setState({
  ...
  render() {
    ...
    return (
      <div className="App">
          ...
          <div class="container">
            <div class="row">
              <div class="col-6" id="profile">
                ...
                <a href="/edit-service-provider-profile">
                  <button id="edit">Edit Profile</button>
                </a>
                <a href="/service-provider-orders">
                  <button id="order">See Orders</button>
                </a>
              </div>
        ...
        <div className="rate2">
          <h5 class="hrate">
            For better customer attraction, verify your skills from here :
            <a href="/skill-verification-request">
              <button id="skillverify">Skill Verification</button>
            </a>
          </h5>
        </div>
